      ...
      <Space direction="vertical" size={16} style={{padding: 16}}>
        <Card title="Settings" style={{width: 400}}>
          ...
          <div style={{marginBottom: 16}}>
            ...
            <Space direction="horizontal" size={2} style={{width: '100%'}}>
              <Radio.Group name="radiogroup" value={movementOption}
                           onChange={handleMovementOptionChange}>
                <Radio value={undefined} className="radioButton">
                  None
                </Radio>
                <Radio value={'rotate'} className="radioButton">
                  Rotate Camera
                </Radio>
                <Radio value={'drag'} className="radioButton">
                  Drag Shape
                </Radio>
              </Radio.Group>
            </Space>
